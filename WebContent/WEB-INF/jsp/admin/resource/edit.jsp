...
<div class="container-fluid">
	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
		  <h5 class="txt-dark">Sửa nguồn tin</h5>
		</div>
		<!-- Breadcrumb -->
			...
			<div class="panel panel-default card-view">
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						<div class="form-wrap">
							<form id="edit_cat" action="${pageContext.request.contextPath }/admin/resource/edit/${objResource.id}" method="post">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label mb-10">Tên nguồn tin</label>
											<input name="name" type="text" id="name" class="form-control" placeholder="Tên danh mục" value="${objResource.name }">
										</div>
									</div>
									<!--/span-->
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="link" type="text" id="link" class="form-control" placeholder="URL hình ảnh" value="${objResource.link }">
										</div>
									</div>
									<!--/span-->
								</div>
