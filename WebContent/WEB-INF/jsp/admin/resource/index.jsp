...
<div class="container-fluid">
	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
		  <h5 class="txt-dark">Nguồn tin</h5>
		</div>
		<!-- Breadcrumb -->
			...
			<div class="panel panel-default card-view">						
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						...
						<p class="text-muted">
							<a class="btn btn-success btn-anim" href="${pageContext.request.contextPath }/admin/resource/add">
								<span>Add</span>
							</a>
						</p>
						<div class="table-wrap mt-40">
							<div class="table-responsive">
							  <table class="table table-hover table-bordered mb-0 tree">
								...
								<tbody>
								<c:forEach items="${alResource }" var="objResource">
								<c:set var="urlEdit" value="${pageContext.request.contextPath }/admin/resource/edit/${objResource.id }"></c:set>
								<c:set var="urlDel" value="${pageContext.request.contextPath }/admin/resource/del/${objResource.id }"></c:set>
									  <tr>
										<td>${objResource.name }</td>
										<td>${objResource.link }</td>
